*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZADOV_GRAINS_015
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZADOV_GRAINS_015    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZADOV_GRAINS_015'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZADOV_GRAINS_015_EXTRACT
TOTAL = ZADOV_GRAINS_015_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZADOV_GRAINS_015'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZADOV_GRAINS_015-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZADOV_GRAINS_015_EXTRACT
TOTAL = ZADOV_GRAINS_015_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZADOV_GRAINS_015-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZADOV_GRAINS_015'
...
TOTAL = ZADOV_GRAINS_015_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZADOV_GRAINS_015-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZADOV_GRAINS_015-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZADOV_GRAINS_015'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZADOV_GRAINS_015-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZADOV_GRAINS_015_EXTRACT
TOTAL = ZADOV_GRAINS_015_TOTAL
