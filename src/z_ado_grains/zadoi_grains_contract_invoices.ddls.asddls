@AbapCatalog.sqlViewName: 'ZADOIGRAINSCI'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Grains - Invoices do Contrato'
define view ZADOI_GRAINS_CONTRACT_INVOICES
  ...
  //                                                                            and FirstFixationBil.IdentificationFix = FixationBil.identification_fix
    ...
    left outer join ZADOC_GRAINS_TRUE_UP_DIFF_APP  as TrueUpAppQuantity     on  SettlementHeader.appldoc      = TrueUpAppQuantity.ApplicationDoc
                                                                            and SettlementHeader.appldoc_item = TrueUpAppQuantity.ApplicationDocItem
                                                                            and SettlementHeader.side         = TrueUpAppQuantity.Side
...

{
  ...
  key SettlementPrice.pr_count                                       as PriceCount,
      ...
      Fixation.fixation_id                                           as FixationIdFromZTable,
      ...
      cast(
        cast(dats_days_between( SettlementPrice.pr_date, Fixation.payment_date )
          as abap.char( 20 ) )
      ...
      SettlementHeader.side                                          as AppSide,
...
//      @Semantics.quantity.unitOfMeasure: 'FixationUom'
//      cast (Fixation.quantity     as zadode_grains_quant_to_clear)   as QuantityToClear,


      @Semantics.quantity.unitOfMeasure: 'NfUom'
      TrueUpAppQuantity.NfQuantity,
      TrueUpAppQuantity.NfUom,
      TrueUpAppQuantity.QuantityTrueUpDiff,
      TrueUpAppQuantity.ApplicationDiffStatus,
      TrueUpAppQuantity.ApplicationDiffStatusDescr,
      TrueUpAppQuantity.ApplicationTrueUpGuid,
      ...
      InvoiceHeader.xblnr                                            as InvoiceReference,
      InvoiceHeader.sgtxt                                            as TextItem,
